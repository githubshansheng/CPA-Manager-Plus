...
export const getDemoUsageServiceStatus = (): UsageServiceStatus => ({
  ...
  databases: {
    sqlite: {
      ...
      shmBytes: 32_768,
      totalBytes: 2_751_496_192,
      effectiveBytes: 2_403_450_880,
      reusableBytes: 280_903_680,
      retentionDays: 15,
      cleanupStatus: 'idle',
      checkpoint: {
        mode: 'passive',
    ...
    mysql: {
      ...
      connected: true,
      available: true,
      maskedAddress: 'mysql.internal:3306',
      database: 'cpamp',
      version: 'MySQL 8.4.3',
      pingLatencyMs: 6,
      uptimeSeconds: 864_000,
      databaseBytes: 8_912_896_000,
      tableBytes: 7_516_192_768,
      indexBytes: 1_396_703_232,
      pool: { open: 12, inUse: 3, idle: 9, waitCount: 7, maxOpen: 32 },
      connections: { value: 18, available: true },
      maxConnections: { value: 200, available: true },
      queriesPerSecond: { value: 142.4, available: true },
      transactionsPerSecond: { value: 28.6, available: true },
      slowQueries: { permissionDenied: true },
      bufferPoolBytes: { value: 4_294_967_296, available: true },
      lockWaits: { value: 0, available: true },
      deadlocks: { value: 1, available: true },
    },
  },
  replication: {
    enabled: true,
    ...
    epoch: 3,
    sourceWatermark: 184_260,
    targetWatermark: 184_260,
    pendingRows: 0,
    pendingMutations: 0,
    pendingBytes: 0,
    throughputRowsPerSecond: 86.2,
    mutationsPerSecond: 86.2,
    retries: 2,
    retryCount: 2,
    lastSuccessAtMs: now() - 4_000,
    heartbeatAtMs: now() - 2_000,
    state: 'running',
    stalled: false,
  },
  databaseMigration: {
    id: 'demo-migration-001',
    state: 'validated',
    status: 'running',
    ...
    copiedRows: 184_260,
    totalRows: 184_260,
    copiedBytes: 8_912_896_000,
    totalBytes: 8_912_896_000,
    rowsPerSecond: 625,
    validationValid: true,
    validationToken: 'demo-validation-token',
    tables: [
      { table: 'usage_events', name: 'usage_events', copiedRows: 184_260, totalRows: 184_260 },
      { table: 'settings', name: 'settings', copiedRows: 48, totalRows: 48 },
    ],
  },
  cacheCoverage: {
    complete: false,
    ...
    toId: 184_260,
    watermark: 184_260,
    minimumEventId: 142_301,
    maximumEventId: 184_260,
    syncedWatermark: 184_260,
    retentionDays: 15,
    cleanupEnabled: false,
    cleanupState: 'idle',
    lastCleanupAtMs: now() - day,
  },
});
